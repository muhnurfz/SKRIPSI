...
<div id="notification-container"></div>
    ...
    <div class="container">
        ...
        <form action="process_ticket.php" method="POST">
           ...
           <input type="tel" id="passenger_phone" name="passenger_phone" maxlength="19" required oninput="formatPhoneNumber(event)">

            <label for="email">Email Penumpang:</label>
            <input type="email" id="email" name="email" placeholder="example@gmail.com"  pattern="^[a-zA-Z0-9._%+-]+@gmail\.com$" title="Hanya alamat email dengan domain @gmail.com yang diterima">
