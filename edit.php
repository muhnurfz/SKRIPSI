        ...
        if ($stmt->execute()) {
            ...
            if (!empty($email)) {
                ...
                try {
                    ...
                    // Konten email
                    $mail->isHTML(true);
                    $mail->Subject = 'Pembaruan Data Pemesanan';
    ...
    <style>
        ...
        .details td, .details th {
          border: 1px solid #ddd;
            padding: 8px;
            text-align: left; /* Rata kiri untuk <td> dan <th> */
        }
        .details th {
...
<body>
    <h2>Pembaruan Data Pemesanan</h2>
    <p>Data pemesanan Anda telah diperbarui pada ' . $formatted_date . ' ' . $formatted_time . '.</p>
    <div class="content">
        <h3>Berikut detailnya:</h3>
        <table class="details">
            <tr>
                <th>Nama</th>
                <td>' . htmlspecialchars($passenger_name) . '</td>
            </tr>
            <tr>
                <th>Nomor Telepon</th>
                <td>' . htmlspecialchars($passenger_phone) . '</td>
            </tr>
            <tr>
                <th>Email</th>
            ...
            <tr>
                <th>Total Tariff</th>
                <td>' . number_format($totalTariff, 0, ',', '.') . '</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>' . htmlspecialchars($comment) . '</td>
                    ...
                    $mail->send();
                    $update_msg .= " Email pemberitahuan telah dikirim!";
                } catch (Exception $e) {
                    $update_msg .= " Email pemberitahuan gagal dikirim. Error: " . $mail->ErrorInfo;
                }
            }
        } else {
