...
<div id="notification-container"></div>
    ...
    <div class="container">
        ...
        <input type="text" id="passenger_phone" name="passenger_phone" class="form-control" value="<?= htmlspecialchars($row['passenger_phone']); ?>" maxlength="19" required oninput="formatPhoneNumber(event)">
        ...
        <!-- Input Penumpang Balita/Anak-anak -->
            <div class="form-group" style="display: inline-block; width: 48%;">
                ...
                <input type="number" id="pnp_balita" name="pnp_balita" min="0" max="4" class="form-control" value="0" required>
            </div>
